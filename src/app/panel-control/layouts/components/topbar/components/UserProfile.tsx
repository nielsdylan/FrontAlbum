import { userDropdownItems } from '@/app/panel-control/layouts/components/data'
...
import { logOut } from '@/app/panel-control/services/auth/AuthService';
...
const UserProfile = () => {
  const handleLogout = async (e: React.MouseEvent) => {
      ...
      try {
          ...
          localStorage.removeItem('userToken'); // Asegúrate de borrar los correctos
